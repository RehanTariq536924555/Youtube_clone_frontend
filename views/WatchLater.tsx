...
import { Clock, Trash2, Play, MoreVertical, Share2, PlayCircle } from 'lucide-react';
...
export const WatchLater: React.FC = () => {
  ...
  const loadWatchLaterVideos = async () => {
    try {
      setIsLoading(true);
      setError('');
      const data = await watchLaterService.getWatchLaterVideos();
        ...
        <div className="max-w-[1800px] mx-auto px-6 py-6">
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-32 h-32 bg-zinc-900 rounded-full flex items-center justify-center mb-6">
              <Clock className="text-zinc-600" size={64} />
            </div>
            <h2 className="text-2xl font-semibold text-white mb-2">No videos saved</h2>
    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-[1800px] mx-auto px-6 py-6">
        <div className="flex gap-6 flex-col lg:flex-row">
          {/* Playlist Info Panel - YouTube Style */}
          <div className="lg:w-[400px] shrink-0">
            <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-xl overflow-hidden sticky top-6">
              ...
              <div className="p-6">
                ...
                <button
                  onClick={() => videos[0] && handleVideoClick(videos[0].id)}
                  className="w-full bg-white hover:bg-zinc-200 text-black font-medium py-3 rounded-full transition-colors flex items-center justify-center gap-2"
                >
                  <Play size={20} />
                  Play all
                </button>
